...
<head>
  ...
  <title>Admin - Customer Payments</title>
  <link rel="stylesheet" href="<?=ROOT?>/public/assets/css/adminbookingDetails.css">
...
<body>
  ...
  <script>
    ...
    function searchCustomer() {
      ...
      fetch('<?=ROOT?>/public/admin/searchBookingDetails', {
        method: 'POST',
    ...
    function loadBookings() {
      try {
        fetch('<?=ROOT?>/public/admin/bookingDetails')
