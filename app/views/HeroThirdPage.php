...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../public/assets/css/HeroThirdPage.css" />
  ...
  <body>
      ...
      <div class="testimonial mySwiper">
        <div class="testi-content swiper-wrapper">
          <div class="slide swiper-slide">
            <img src="../../public/assets/images/Review_Customer_1.png" alt="user1" class="image" />
            <p>
          ...
          <div class="slide swiper-slide">
            <img src="../../public/assets/images/Review_Customer_2.png" alt="user2" class="image" />
            <p>
          ...
          <div class="slide swiper-slide">
            <img src="../../public/assets/images/Review_Customer_3.png" alt="user3" class="image" />
            <p>
    ...
    <script src="../../public/assets/js/ReviewScreenScript.js"></script>
  </body>
</html>