    ...
    <div class="service-form-modal">
        ...
        <div class="service-form-content">
            <form action="SubmitHome_style_food.php" method="post">
                ...
                <!-- hours -->
                <label class="question">How many hours per day?</label>
                <label class="message">Select 1 out of 5 options</label>
                ...
                <!-- addiyional jobs -->
                <label class="question">Want some odd jobs done in free time?</label>
                <label class="message">Select 1 out of 2 options</label>

                <div class="options-container">
                    <label class="option">
                        <input type="radio" name="add-ons" value="1" required>
                        <span>Yes (like Ironing,Folding & Dusting)</span>
                    </label>
                    <label class="option">
                        <input type="radio" name="add-ons" value="2" >
                        <span>No</span>
                    </label>
            ...
            <label class="question">Inclusions</label>
            <label class="message">This service includes</label>

            <label class="message" style="color: #4C9EBE;">
            Our babysitters in this category have expertise in all things related to diapers, formula milk, massaging, sterilising,
             bathing, burping, washing of clothes, taking care of hygiene, nail cutting, basic food for baby like daliyaa, khichdi,
             playing with babies and making them sleep, packing baby travel bag, etc.
            </label>
            </div>
