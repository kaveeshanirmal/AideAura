...
<body>
    <div class="service-form-modal">
        ...
        <div class="service-form-content">
            ...
            <!-- NO of children -->
                <label class="question">How many children do you want the Nanny for?</label>
                <label class="message">Select 1 out of 2 options</label>

                <div class="options-container">
                    <label class="option">
                        <input type="radio" name="children" value="1" required>
                        <span>I need a Nanny for one child</span>
                    </label>
                    <label class="option">
                        <input type="radio" name="children" value="2">
                        <span>I need a Nanny for Twins</span>
                    </label>
            ...
            <label class="message" style="color: #4C9EBE;">
                Japa maids are expert caretakers of new born babies and moms. From swaddling, spoon-feeding and massaging the baby,
                 to taking care of the mother's well being and helping with her meals, a japa maid does it all!
            </label>
            </div>
