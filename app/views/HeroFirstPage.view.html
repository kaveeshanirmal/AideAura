...
<head>
    ...
    <link rel="stylesheet" href="../../public/assets/css/HeroFirstPage.css">
    <style>
...
<body>
    ...
    <section class="page-1">
        ...
        <button class="glow-button">Find a Worker</button>
        <div class="background-image">
            <img src="../../public/assets/images/Hero_Screen_1_Background.png" class="background-image" alt="background">
        </div>
    </section>
    ...
    <section class="page-2">
        <div class="background-image">
            <img src="../../public/assets/images/Hero_Slider_1.png" class="background-image" alt="background">
            <img src="../../public/assets/images/Loading_Screen_Background_Front_Layer.png" class="background-layer" alt="bg-layer">
        </div>
        <div class="container">
            <div id="slide">
                <!-- Slide 1 -->
                <div class="item" style="background-image: url(../../public/assets/images/Hero_Slider_1.png);">
                    <div class="content">
                        <div class="name">Babysitting</div>
                ...
                <!-- Slide 2 -->
                <div class="item" style="background-image: url(../../public/assets/images/Hero_Slider_2.png);">
                    <div class="content">
                ...
                <!-- Slide 3 -->
                <div class="item" style="background-image: url(../../public/assets/images/Hero_Slider_3.png);">
                    <div class="content">
                ...
                <!-- Slide 4 -->
                <div class="item" style="background-image: url(../../public/assets/images/Hero_Slider_4.png);">
                    <div class="content">
                        <div class="name">Gardening</div>
                        <div class="description">
                ...
                <!-- Slide 5 -->
                <div class="item" style="background-image: url(../../public/assets/images/Hero_Slider_5.png);">
                    <div class="content">
            ...
            <div class="buttons">
                <button id="prev"><img src="../../public/assets/images/Prev_Icon.png" alt="prev_button"></button>
                <button id="next"><img src="../../public/assets/images/Next_Icon.png" alt="next_button"></button>
            </div>
        </div>
    
        <script src="../../public/assets/js/HeroSectionScript.js"></script>
    ...
    <section class="page-3">
        <div class="background-image">
            <img src="../../public/assets/images/Hero_Screen_3_Background.png" class="background-image" alt="background">
        </div>
    </section>
