...
<head>
    ...
    <link rel="stylesheet" href="<?=ROOT?>/public/assets/css/financeMPaymentHistory.css">
</head>
<body>
<div class="main-container">
    <?php
    include(ROOT_PATH . '/app/views/components/financeM_side_bar.view.php'); 
    ?>
    
    <div class="content-container">
        <?php
        include(ROOT_PATH . '/app/views/components/financeM_navbar.view.php');
        ?>
