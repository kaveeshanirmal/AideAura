...
--
-- Host: localhost
-- Generation Time: Apr 23, 2025 at 07:57 AM
...
--
-- Indexes for table `workercomplaints`
--
ALTER TABLE `workercomplaints`
  ADD PRIMARY KEY (`complaintID`);

--
-- Indexes for table `workercomplaints_updates`
--
...
--
ALTER TABLE `workercomplaints`
  MODIFY `complaintID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
