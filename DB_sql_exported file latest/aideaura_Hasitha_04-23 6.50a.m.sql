...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2025 at 03:16 AM
...
(9, 'test33', 'public/assets/images/roles/', 'This is special role for test 33', 0),
(11, 'test4', 'public/assets/images/roles/', '                        gghgkjhgkjgkjhgkjg    ', 1),
...
(55, 'testcase 34', 'public/assets/images/roles/67a0cc487114e_20230816_125947.jpg', 'dhsafhjkdfkjasfkjhdaslkjfjkdaflkjdsaflkasdlkfjhlkjfhlkasdjdfhkajhfgdk', 1),
(56, 'test002', 'public/assets/images/roles/67ae21d830cf1_20230816_125951.jpg', 'ujfjsfjdsjklksdjlksdjflkjsdkljsajkfdslkjfsljfdslakflk', 1),
...
(58, 'test Cleaner', 'public/assets/images/roles/6804935731f6c_20230816_125947.jpg', 'special cleaner for test', 0);
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `update_service_type`;
DELIMITER $$
CREATE TRIGGER `update_service_type` AFTER UPDATE ON `jobroles` FOR EACH ROW BEGIN
    UPDATE payment_rates
    SET ServiceType = NEW.name
    WHERE ServiceType = OLD.name;
END
$$
DELIMITER ;
...
(20, 'admin', 'Kamala', 'Gunaratnet', 'admin', '$2y$10$tTsTz97ibBL/WAsXWvuKN.II41Z1FmIvyZV78II1.xqo8rcjzQsJK', 771234563, 'admin@aideaura.com', '2024-11-19 23:42:09', 0),
...
(27, 'opmanager', 'Waruna', 'Chathuranga', 'opManager', '$2y$10$qh.mR.ZUZMbWHUNVHPSCZe9Ho29DsO45Y/7ZqPmZE1HtZxp6wVE8e', 248794653, 'kamal@gmail.com', '2024-12-28 09:33:50', 0),
...
(63, 'maid0001', 'Kusum', 'DHA', 'worker', '$2y$10$8fDSwJwNazIbqm//Wt70p.OVVbUXeniH62Ztd1nQ7E5SJwmmxOo4y', 2147483647, 'veen1234@gamil.com', '2025-04-22 16:36:51', 0);
...
(1, 45, 'Anura wicramasinghe', 'testworker1', 'anura.123@gmail.com', '0786581230', 'male', 'Sinhala', 'Colombo', '198616382678', 'sinhalese', '26-35', 'cooking', 'intermediate', 'Vavuniya', NULL, NULL, 'Hi, I would really like to get verified.', 'BOC\r\n1233', '2002286546179334', '7-9', '7-9', 'I don\'t have allergies', 'Please consider my verification request', 1, 'approved', '2025-04-22 16:30:23', '2025-04-22 16:37:48'),
...
(15, 30, '/public/assets/images/avatar-image.png', 'jjdfgkjdsfkdfkjgdkjh', 0, 'online'),
...
(18, 33, '/public/assets/images/avatar-image.png', 'jjdfgkjdsfkdfkjgdkjh', 0, 'online'),
...
(22, 39, '/public/assets/images/avatar-image.png', 'jjdfgkjdsfkdfkjgdkjh', 1, 'offline'),
...
(45, 63, '/public/assets/images/avatar-image.png', 'jjdfgkjdsfkdfkjgdkjh', 0, 'offline');
...
--
ALTER TABLE `jobroles`
  MODIFY `roleID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
ALTER TABLE `verification_requests`
  MODIFY `requestID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
