...
function validateInput(input) {
  ...
  switch (input.getAttribute("id")) {
      ...
      case "workingWeekends":
          if (!value) {
              showError(input, "Please select working hours for week ends!");
              return false;
          }
          break;
  }
...
//     // Age Validation
//     const workingHourseWeekdays = document.querySelector('select[placeholder = "Select working hours"]');
//     if (!workingHourseWeekdays) {
//       alert("Please include compatible working hours for week days!");
//       isValid = false;
//     }
  
//     // Service Type Validation
//     const workingHoursWeekend = document.querySelector('select[placeholder = "Select working hours"]');
//     if (!workingHoursWeekend) {
//       alert("Please include compatible working hours for week end!");
//       isValid = false;
//     }
