...
function saveFormData() {
  ...
  formData["selectedGender"] = selectedGender ? selectedGender.value : null;
...
function restoreFormData() {
  ...
  if (savedData) {
      ...
      if (formData["selectedGender"]) {
          const genderInput = document.querySelector(`input[name="gender"][value="${formData["selectedGender"]}"]`);
          if (genderInput) {
